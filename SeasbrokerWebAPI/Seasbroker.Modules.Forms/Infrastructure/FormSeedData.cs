        ...
        new FormSchemaDto
        {
            Sections =
            {
                Section("cargo-details", "Cargo Details", 0,
                    ...
                    Text("commodity", "Commodity / Cargo Description", 2, required: true, width: FormFieldWidth.Half,
                        placeholder: "e.g. Wheat, Steel Coils, Machinery"),
                    Number("weight", "Total Quantity (MT)", 3, required: true, systemKey: FormsConstants.SystemFieldKeys.Weight, width: FormFieldWidth.Half,
                ...
                Section("dry-bulk", "Dry Bulk", 3,
                    ...
                    ConditionalOnCargoType("Dry Bulk", Number("dryBulkQuantity", "Quantity (MT)", 1, required: true, width: FormFieldWidth.Third)),
                ...
                Section("breakbulk", "General & Breakbulk Cargo", 4,
                    ...
                    ConditionalOnCargoType("General & Breakbulk Cargo", Number("bbWeight", "Total Gross Weight (MT)", 4, required: true, width: FormFieldWidth.Third)),
                ...
                Section("project-heavy-lift", "Project & Heavy-Lift Cargo", 5,
                    ...
                    ConditionalOnCargoType("Project & Heavy-Lift Cargo", Number("projWeight", "Total Weight (MT)", 2, required: true, width: FormFieldWidth.Third)),
                ...
                Section("containerized", "Containerized Cargo", 6,
                    ...
                    ConditionalOnCargoType("Containerized Cargo", Number("containerWeight", "Gross Weight per Container (MT)", 5, required: true, width: FormFieldWidth.Third)),
                ...
                Section("roro", "RoRo Cargo", 7,
                    ...
                    ConditionalOnCargoType("RoRo", Number("roroWeight", "Weight per Unit (MT)", 6, required: true, width: FormFieldWidth.Third)),
                ...
                Section("gas-cargo", "Gas Cargo", 9,
                    ...
                    ConditionalOnCargoType("Gas", Number("gasQuantity", "Quantity", 2, required: true, width: FormFieldWidth.Third)),
                ...
                Section("other-cargo", "Other / Not Sure", 11,
                    ...
                    ConditionalOnCargoType("Other", Number("otherWeight", "Total Weight (MT)", 2, required: true, width: FormFieldWidth.Third)),
